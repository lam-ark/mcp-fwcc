---
id: "cc_slot_module:BetHistoryDetailModule:methods:getCurrentData"
title: "BetHistoryDetailModule.getCurrentData Method"
category: "cc_slot_module"
tags: ["BetHistoryDetailModule", "bethistorydetailmodule", "cc_slot_module", "methods", "getCurrentData"]
---

# 📖 `BetHistoryDetailModule.getCurrentData()`

---

## 1. Method Overview & Signature

Retrieves current step item from gameModeData at currentIndex.
...
- **Caller / Trigger**: Internal helper method.
