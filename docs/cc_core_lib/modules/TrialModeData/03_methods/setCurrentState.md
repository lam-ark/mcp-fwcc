...
title: "TrialModeData.setCurrentState Method Implementation & Walkthrough"
category: "cc_core_lib"
tags: ["TrialModeData", "trial_mode_data", "cc_core_lib", "methods", "setCurrentState"]
---
...
- **Scope**: `eno.TrialModeData.setCurrentState`
...
setCurrentState(state: number): void {
    // Execution pipeline for `TrialModeData.setCurrentState`
