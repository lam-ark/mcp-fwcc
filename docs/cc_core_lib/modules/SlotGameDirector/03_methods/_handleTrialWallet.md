...
title: "Cách dùng SlotGameDirector._handleTrialWallet() & Giải thích chi tiết"
category: "cc_core_lib"
tags: ["SlotGameDirector", "slot_game_director", "cc_core_lib", "methods", "_handleTrialWallet", "usage", "guide"]
---

# 📖 `SlotGameDirector._handleTrialWallet()`

> **Mô tả ngắn**: Thực hiện chức năng `_handleTrialWallet` cho class `SlotGameDirector`.
