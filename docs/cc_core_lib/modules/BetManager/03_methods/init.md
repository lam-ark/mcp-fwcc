---
id: "cc_core_lib:BetManager:methods:init"
title: "BetManager.init Method Implementation & Walkthrough"
category: "cc_core_lib"
tags: ["BetManager", "bet_manager", "cc_core_lib", "methods", "init"]
---
...
```typescript
init(): void {
    // Method execution logic for BetManager.init
...
- Performs state mutations on `BetManager` internal properties.
