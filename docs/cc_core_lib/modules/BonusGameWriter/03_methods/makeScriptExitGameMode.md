...
title: "Cách dùng BonusGameWriter.makeScriptExitGameMode() & Giải thích chi tiết"
category: "cc_core_lib"
tags: ["BonusGameWriter", "bonus_game_writer", "cc_core_lib", "methods", "makeScriptExitGameMode", "usage", "guide"]
---

# 📖 `BonusGameWriter.makeScriptExitGameMode()`

> **Mô tả ngắn**: Thực hiện chức năng `makeScriptExitGameMode` cho class `BonusGameWriter`.
