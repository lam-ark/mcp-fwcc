...
title: "Cách dùng BonusGameWriter.makeScriptResultReceived() & Giải thích chi tiết"
category: "cc_core_lib"
tags: ["BonusGameWriter", "bonus_game_writer", "cc_core_lib", "methods", "makeScriptResultReceived", "usage", "guide"]
---

# 📖 `BonusGameWriter.makeScriptResultReceived()`

> **Mô tả ngắn**: Thực hiện chức năng `makeScriptResultReceived` cho class `BonusGameWriter`.
