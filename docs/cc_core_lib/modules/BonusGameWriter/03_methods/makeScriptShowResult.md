...
title: "Cách dùng BonusGameWriter.makeScriptShowResult() & Giải thích chi tiết"
category: "cc_core_lib"
tags: ["BonusGameWriter", "bonus_game_writer", "cc_core_lib", "methods", "makeScriptShowResult", "usage", "guide"]
---

# 📖 `BonusGameWriter.makeScriptShowResult()`

> **Mô tả ngắn**: Thực hiện chức năng `makeScriptShowResult` cho class `BonusGameWriter`.
