...
title: "JackpotManager.getJackpotData Method Implementation & Walkthrough"
category: "cc_core_lib"
tags: ["JackpotManager", "jackpot_manager", "cc_core_lib", "methods", "getJackpotData"]
---
...
- **Scope**: `eno.JackpotManager.getJackpotData`
...
getJackpotData(): JackpotData {
    // Execution pipeline for `JackpotManager.getJackpotData`
