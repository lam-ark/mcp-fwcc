...
# 💡 Recipe: Practical `SceneUtils` Integration
...
```typescript
import { SceneUtils } from "cc-core-lib";

// 1. Accessing via global eno namespace or modular import
const instance = new SceneUtils();
...
In production slot titles like **Red Cliff (g9666)**, `SceneUtils` integrates directly into the Director and Writer modules to maintain seamless state synchronization across Base Game, Free Spins, and Respin cascades.
