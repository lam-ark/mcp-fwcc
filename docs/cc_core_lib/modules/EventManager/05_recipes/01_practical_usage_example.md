...
# 💡 Recipe: Practical `EventManager` Integration
...
```typescript
import { EventManager } from "cc-core-lib";
...
In production slot titles like **Red Cliff (g9666)**, `EventManager` integrates directly into the Director and Writer modules to maintain seamless state synchronization across Base Game, Free Spins, and Respin cascades.
