...
title: "Cách dùng GameStateManager.bindTutorialData() & Giải thích chi tiết"
category: "cc_core_lib"
tags: ["GameStateManager", "game_state_manager", "cc_core_lib", "methods", "bindTutorialData", "usage", "guide"]
---

# 📖 `GameStateManager.bindTutorialData()`

> **Mô tả ngắn**: Thực hiện chức năng `bindTutorialData` cho class `GameStateManager`.
...
// Gọi phương thức:
// GameStateManager.bindTutorialData(tutorialData: any);
```
