...
title: "Cách dùng FreeGameWriter.makeScriptExitGameMode() & Giải thích chi tiết"
category: "cc_core_lib"
tags: ["FreeGameWriter", "free_game_writer", "cc_core_lib", "methods", "makeScriptExitGameMode", "usage", "guide"]
---

# 📖 `FreeGameWriter.makeScriptExitGameMode()`

> **Mô tả ngắn**: Thực hiện chức năng `makeScriptExitGameMode` cho class `FreeGameWriter`.
