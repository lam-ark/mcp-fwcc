...
title: "Cách dùng FreeOptionWriter.makeScriptExitGameMode() & Giải thích chi tiết"
category: "cc_core_lib"
tags: ["FreeOptionWriter", "free_option_writer", "cc_core_lib", "methods", "makeScriptExitGameMode", "usage", "guide"]
---

# 📖 `FreeOptionWriter.makeScriptExitGameMode()`

> **Mô tả ngắn**: Thực hiện chức năng `makeScriptExitGameMode` cho class `FreeOptionWriter`.
