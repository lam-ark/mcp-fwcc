...
title: "DialogManager.getDialogData Method Implementation & Walkthrough"
category: "cc_core_lib"
tags: ["DialogManager", "dialog_manager", "cc_core_lib", "methods", "getDialogData"]
---
...
- **Scope**: `eno.DialogManager.getDialogData`
...
getDialogData(): DialogData {
    // Execution pipeline for `DialogManager.getDialogData`
