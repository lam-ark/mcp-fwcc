...
title: "Cách dùng GameStateWrap._triggerGetLatestStatePrivate() & Giải thích chi tiết"
category: "cc_core_lib"
tags: ["GameStateWrap", "game_state_wrap", "cc_core_lib", "methods", "_triggerGetLatestStatePrivate", "usage", "guide"]
---

# 📖 `GameStateWrap._triggerGetLatestStatePrivate()`

> **Mô tả ngắn**: Thực hiện chức năng `_triggerGetLatestStatePrivate` cho class `GameStateWrap`.
...
// Gọi phương thức:
// GameStateWrap._triggerGetLatestStatePrivate(metaData: any);
```
