...
- **Source File**: `assets/cc-common/cc-slot-mechanics/HorizontalReel/scripts/HorizontalTableTest.ts`
- **Class Hierarchy**: `HorizontalTableTest` ➔ `Component`
...
`HorizontalTableTest` is a core runtime module within the **Horizontal Sub-Reel Mechanics**.
...
```mermaid
graph TD
    SuperClass[Component] --> TargetClass[HorizontalTableTest]
