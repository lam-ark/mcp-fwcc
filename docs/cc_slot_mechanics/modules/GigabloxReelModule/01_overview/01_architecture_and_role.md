...
- **Source File**: `assets/cc-common/cc-slot-mechanics/Gigablox/scripts/GigabloxReelModule.ts`
- **Class Hierarchy**: `GigabloxReelModule` ➔ `SlotReelModule`
...
`GigabloxReelModule` is a core runtime module within the **Gigablox Colossal Symbol Synchronizer**.
...
```mermaid
graph TD
    SuperClass[SlotReelModule] --> TargetClass[GigabloxReelModule]
