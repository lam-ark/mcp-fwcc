...
- **Source File**: `assets/cc-common/cc-slot-mechanics/CascadeWildGeneration/scripts/CascadeWildGenerationSceneTest.ts`
- **Class Hierarchy**: `CascadeWildGenerationSceneTest` ➔ `Component`
...
`CascadeWildGenerationSceneTest` is a core runtime module within the **Cascade Explosion Wild Generator**.
...
```mermaid
graph TD
    SuperClass[Component] --> TargetClass[CascadeWildGenerationSceneTest]
