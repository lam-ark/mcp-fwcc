...
- **Source File**: `assets/cc-common/cc-slot-mechanics/HorizontalReel/scripts/HorizontalTableConfig.ts`
- **Class Hierarchy**: `HorizontalTableConfig` ➔ `TableModuleConfig`
...
`HorizontalTableConfig` is a core runtime module within the **Horizontal Sub-Reel Mechanics**.
...
```mermaid
graph TD
    SuperClass[TableModuleConfig] --> TargetClass[HorizontalTableConfig]
