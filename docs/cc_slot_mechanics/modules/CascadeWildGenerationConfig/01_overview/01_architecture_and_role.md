...
- **Source File**: `assets/cc-common/cc-slot-mechanics/CascadeWildGeneration/scripts/CascadeWildGenerationConfig.ts`
- **Class Hierarchy**: `CascadeWildGenerationConfig` ➔ `CascadeModuleConfig`
...
`CascadeWildGenerationConfig` is a core runtime module within the **Cascade Explosion Wild Generator**.
...
```mermaid
graph TD
    SuperClass[CascadeModuleConfig] --> TargetClass[CascadeWildGenerationConfig]
