...
- **Source File**: `assets/cc-common/cc-slot-mechanics/HorizontalReel/scripts/HorizontalReelModule.ts`
- **Class Hierarchy**: `HorizontalReelModule` ➔ `SlotReelModule`
...
`HorizontalReelModule` is a core runtime module within the **Horizontal Sub-Reel Mechanics**.
...
```mermaid
graph TD
    SuperClass[SlotReelModule] --> TargetClass[HorizontalReelModule]
